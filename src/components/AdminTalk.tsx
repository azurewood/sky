        ...
        {open() ? (showUser() ?
          ...
          <div class="flex flex-col px-5 gap-y-1 h-[200px]">
            <form onSubmit={onSubmit}>
              <div class="relative w-full min-w-[200px] min-h-max">
              ...
              <div class="flex flex-row justify-center gap-x-9">
                <button onclick={handleShowUser} class={"w-32 mb-0 self-center select-none border shadow active:translate-y-px active:translate-x-px dark:bg-zinc-100 bg-zinc-900 border-zinc-900 py-1.5 dark:border-zinc-100 rounded-full mt-2 dark:text-zinc-900 text-zinc-100 font-medium text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:focus:ring-offset-zinc-700 disabled:opacity-50 disabled:cursor-not-allowed" + (userInfo()?.user ? "" : " disabled")}>🏃🏻‍♂️💨</button>
