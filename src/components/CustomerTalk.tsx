import { createSignal, type JSX, type Setter, type Accessor, useContext, For } from "solid-js";
import DataContext, { updateState } from ".";
import { type Message } from "./MessageItem";
import HistoryItem from "./HistoryItem";

const CustomerTalk = ({ from, owner, selection, sending, setSending, open, setOpen, history, showSide, setShowSide }: { selection: Accessor<{ id: string, uid: string, name?: string } | undefined>, showSide: Accessor<boolean>, setShowSide: Setter<boolean>, history: Accessor<Message[]>, open: Accessor<boolean>, setOpen: Setter<boolean>, from: string, owner: string, sending: Accessor<boolean>, setSending: Setter<boolean> }) => {
  ...
  return (
    <>
      <div class="md:w-96 flex flex-col justify-between text-blue-200 shadow-inner rounded px-0 pt-3 pb-1 bg-blue-600">
        ...
        <div class="w-full self-center mb-1 text-lg flex flex-row px-5 pb-1 gap-y-1"><a href="#" onClick={handleOpen} class="text-center flex-grow">Talk to Sky</a>
          {open() ?
            <div>
